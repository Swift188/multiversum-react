    ...
    return (
        <div class='container mt-5 mb-5 text-white'>
            ...
            <p>
                ...
                Organisatie (hierna: Thuiswinkel.org) zijn tot stand gekomen in
                overleg met de Consumentenbond in het kader van de
                Coördinatiegroep Zelfreguleringsoverleg (CZ) van de
            ...
            <ol>
                <li>
                    <strong>Aanvullende overeenkomst</strong>: een overeenkomst
                    waarbij de consument producten, digitale inhoud en/of
                    diensten verwerft in verband met een overeenkomst op afstand
                    en deze zaken, digitale inhoud en/of diensten door de
                    ondernemer worden geleverd of door een derde partij op basis
                ...
                <li>
                    <strong>Consument</strong>:<strong> </strong>de natuurlijke
                    persoon die niet handelt voor doeleinden die verband houden
                    met zijn handels-, bedrijfs-, ambachts- of
                    beroepsactiviteit;
                </li>
                <li>
                ...
                <li>
                    <strong>Duurovereenkomst</strong>: een overeenkomst die
                    strekt tot de regelmatige levering van zaken, diensten en/of
                    digitale inhoud gedurende een bepaalde periode;
                </li>
                <li>
                    <strong>Duurzame gegevensdrager</strong>: elk hulpmiddel -
                    waaronder ook begrepen e-mail - dat de consument of
                    ondernemer in staat stelt om informatie die aan hem
                    persoonlijk is gericht, op te slaan op een manier die
                    toekomstige raadpleging of gebruik gedurende een periode die
                    is afgestemd op het doel waarvoor de informatie is bestemd,
                    en die ongewijzigde reproductie van de opgeslagen informatie
                    mogelijk maakt;
                </li>
                <li>
                    <strong>Herroepingsrecht</strong>: de mogelijkheid van de
                    consument om binnen de bedenktijd af te zien van de
                    overeenkomst op afstand;
                </li>
                <li>
                    <strong>Ondernemer</strong>: de natuurlijke of rechtspersoon
                    die lid is van Thuiswinkel.org en producten, (toegang tot)
                    digitale inhoud en/of diensten op afstand aan consumenten
                    aanbiedt;
                </li>
                <li>
                    <strong>Overeenkomst op afstand</strong>: een overeenkomst
                    die tussen de ondernemer en de consument wordt gesloten in
                    het kader van een georganiseerd systeem voor verkoop op
                    afstand van producten, digitale inhoud en/of diensten,
                    waarbij tot en met het sluiten van de overeenkomst
                    uitsluitend of mede gebruik gemaakt wordt van één of meer
                    technieken voor communicatie op afstand;
                </li>
                <li>
                    <strong>Modelformulier voor herroeping</strong>: het in
                    Bijlage I van deze voorwaarden opgenomen Europese
                    modelformulier voor herroeping; Bijlage I hoeft niet ter
                    beschikking te worden gesteld als de consument ter zake van
                ...
                <li>
                    ...
                    overeenkomst, zonder dat consument en ondernemer
            ...
            Naam ondernemer: Multiversum B.V.
            <br />
            ...
            <br />
            <br />
            Telefoonnummer: 030 – 123 456 7<br />
            <br />
            Bereikbaarheid:
            <br />
            ...
            <br />
            <br />
            E-mailadres: info@multiversum.nl
            <br />
            <br />
            KvK-nummer: 87654321
            <br />
            ...
            <ol>
                ...
                <li>
                    ...
                    is, zal de ondernemer voordat de overeenkomst op afstand
                    wordt gesloten, aangeven op welke wijze de algemene
                    voorwaarden bij de ondernemer zijn in te zien en dat zij op
                ...
                <li>
                    ...
                    redelijkerwijs niet mogelijk is, zal voordat de overeenkomst
            ...
            <ol>
                ...
                <li>
                    ...
                    zijn deze een waarheidsgetrouwe weergave van de aangeboden
                    producten, diensten en/of digitale inhoud. Kennelijke
                    vergissingen of kennelijke fouten in het aanbod binden de
                    ondernemer niet.
                </li>
                <li>
                    Elk aanbod bevat zodanige informatie, dat voor de consument
                    duidelijk is wat de rechten en verplichtingen zijn, die aan
            ...
            <p>
                ...
                <strong>-</strong>
                <strong> De overeenkomst</strong>
            </p>
            <ol>
                <li>
                    De overeenkomst komt, onder voorbehoud van het bepaalde in
                    lid 4, tot stand op het moment van aanvaarding door de
                ...
                <li>
                    ...
                    van data en zorgt hij voor een veilige webomgeving. Indien
                ...
                <li>
                    ...
                    feiten en factoren die van belang zijn voor een verantwoord
                    aangaan van de overeenkomst op afstand. Indien de ondernemer
                    op grond van dit onderzoek goede gronden heeft om de
                ...
                <li>
                    De ondernemer zal uiterlijk bij levering van het product, de
                    dienst of digitale inhoud aan de consument de volgende
                    informatie, schriftelijk of op zodanige wijze dat deze door
            ...
            <ol>
                <li>
                    De consument kan een overeenkomst met betrekking tot de
                    aankoop van een product gedurende een bedenktijd van 2 weken
                    zonder opgave van redenen ontbinden. De ondernemer mag de
                    consument vragen naar de reden van herroeping, maar deze
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            als de consument in eenzelfde bestelling meerdere
                            producten heeft besteld: de dag waarop de consument,
                            of een door hem aangewezen derde, het laatste
                            product heeft ontvangen. De ondernemer mag, mits hij
                            de consument hier voorafgaand aan het bestelproces
                            op duidelijke wijze over heeft geïnformeerd, een
                            bestelling van meerdere producten met een
                            verschillende levertijd weigeren.
                        </li>
                        <li>
                            als de levering van een product bestaat uit
                            verschillende zendingen of onderdelen: de dag waarop
                            de consument, of een door hem aangewezen derde, de
                            laatste zending of het laatste onderdeel heeft
                            ontvangen;
                        </li>
                        <li>
                            bij overeenkomsten voor regelmatige levering van
                            producten gedurende een bepaalde periode: de dag
                            waarop de consument, of een door hem aangewezen
            ...
            <ol start='3'>
                <li>
                    De consument kan een dienstenovereenkomst en een
                    overeenkomst voor levering van digitale inhoud die niet op
                    een materiële drager is geleverd gedurende 2 weken zonder
                    opgave van redenen ontbinden. De ondernemer mag de consument
                    vragen naar de reden van herroeping, maar deze niet tot
                    opgave van zijn reden(en) verplichten.
                </li>
                <li>
                    De in lid 3 genoemde bedenktijd gaat in op de dag die volgt
            ...
            <p>
                <em>
                    ...
                    inhoud die niet op een materiële drager is geleverd bij niet
            ...
            <ol start='5'>
                ...
                <li>
                    Indien de ondernemer de in het voorgaande lid bedoelde
                    informatie aan de consument heeft verstrekt binnen twaalf
                    maanden na de ingangsdatum van de oorspronkelijke
                    bedenktijd, verstrijkt de bedenktijd 2 weken na de dag
            ...
            <ol>
                <li>
                    ...
                    het product en de verpakking. Hij zal het product slechts
                    uitpakken of gebruiken in de mate die nodig is om de aard,
                    de kenmerken en de werking van het product vast te stellen.
                    Het uitgangspunt hierbij is dat de consument het product
                    slechts mag hanteren en inspecteren zoals hij dat in een
                    winkel zou mogen doen.
                </li>
                <li>
                    De consument is alleen aansprakelijk voor waardevermindering
                    van het product die het gevolg is van een manier van omgaan
                    met het product die verder gaat dan toegestaan in lid 1.
                </li>
                <li>
                    De consument is niet aansprakelijk voor waardevermindering
                    van het product als de ondernemer hem niet voor of bij het
                    sluiten van de overeenkomst alle wettelijk verplichte
            ...
            <ol>
                ...
                <li>
                    Zo snel mogelijk, maar binnen 14 dagen vanaf de dag volgend
                    op de in lid 1 bedoelde melding, zendt de consument het
                    product terug, of overhandigt hij dit aan (een gemachtigde
                    van) de ondernemer. Dit hoeft niet als de ondernemer heeft
                    aangeboden het product zelf af te halen. De consument heeft
                    de terugzendtermijn in elk geval in acht genomen als hij het
                    product terugzendt voordat de bedenktijd is verstreken.
                </li>
                <li>
                    De consument zendt het product terug met alle geleverde
                    toebehoren, indien redelijkerwijs mogelijk in originele
                    staat en verpakking, en conform de door de ondernemer
                ...
                <li>
                    Indien de consument herroept na eerst uitdrukkelijk te
                    hebben verzocht dat de verrichting van de dienst of de
                    levering van gas, water of elektriciteit die niet gereed
                    voor verkoop zijn gemaakt in een beperkt volume of bepaalde
                    hoeveelheid aanvangt tijdens de bedenktijd, is de consument
                    de ondernemer een bedrag verschuldigd dat evenredig is aan
                    dat gedeelte van de verbintenis dat door de ondernemer is
                    nagekomen op het moment van herroeping, vergeleken met de
                    volledige nakoming van de verbintenis.
                </li>
                <li>
                    De consument draagt geen kosten voor de uitvoering van
                    diensten of de levering van water, gas of elektriciteit, die
                    niet gereed voor verkoop zijn gemaakt in een beperkt volume
                    of hoeveelheid, of tot levering van stadsverwarming, indien:
                    <ul>
                        <li>
                            de ondernemer de consument de wettelijk verplichte
                            informatie over het herroepingsrecht, de
                            kostenvergoeding bij herroeping of het
                            modelformulier voor herroeping niet heeft verstrekt,
                            of;
                        </li>
                        <li>
                            de consument niet uitdrukkelijk om de aanvang van de
                ...
                <li>
                    De consument draagt geen kosten voor de volledige of
                    gedeeltelijke levering van niet op een materiële drager
                    geleverde digitale inhoud, indien:
                    <ul>
                        <li>
                            hij voorafgaand aan de levering ervan niet
                            uitdrukkelijk heeft ingestemd met het beginnen van
                            de nakoming van de overeenkomst voor het einde van
                            de bedenktijd;
                        </li>
                        <li>
                            hij niet heeft erkend zijn herroepingsrecht te
            ...
            <ol>
                <li>
                    Als de ondernemer de melding van herroeping door de
                    consument op elektronische wijze mogelijk maakt, stuurt hij
                    na ontvangst van deze melding onverwijld een
                    ontvangstbevestiging.
                </li>
                <li>
                    De ondernemer vergoedt alle betalingen van de consument,
                    inclusief eventuele leveringskosten door de ondernemer in
                    rekening gebracht voor het geretourneerde product,
                    onverwijld doch binnen 14 dagen volgend op de dag waarop de
            ...
            <p>
                ...
                van het herroepingsrecht, maar alleen als de ondernemer dit
                duidelijk bij het aanbod, althans tijdig voor het sluiten van de
                overeenkomst, heeft vermeld:
            </p>
            <ol>
                <li>
                    Producten of diensten waarvan de prijs gebonden is aan
                ...
                <li>
                    ...
                    consument die persoonlijk aanwezig is of de mogelijkheid
                    krijgt persoonlijk aanwezig te zijn op de veiling, onder
                    leiding van een veilingmeester, en waarbij de succesvolle
                    bieder verplicht is de producten, digitale inhoud en/of
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            de uitvoering is begonnen met uitdrukkelijke
                            voorafgaande instemming van de consument; en
                        </li>
                        <li>
                            de consument heeft verklaard dat hij zijn
                            herroepingsrecht verliest zodra de ondernemer de
                            overeenkomst volledig heeft uitgevoerd;
                        </li>
                    </ul>
                </li>
                <li>
                    Pakketreizen als bedoeld in artikel 7:500 BW en
                    overeenkomsten van personenvervoer;&nbsp;
                </li>
                <li>
                    Dienstenovereenkomsten voor terbeschikkingstelling van
                ...
                <li>
                    Overeenkomsten met betrekking tot vrijetijdsbesteding, als
                    in de overeenkomst een bepaalde datum of periode van
                ...
                <li>
                    ...
                    van de consument, of die duidelijk voor een specifieke
                    persoon bestemd zijn;
                </li>
                <li>
                    Producten die snel bederven of een beperkte houdbaarheid
                    hebben;
                </li>
                <li>
                    Verzegelde producten die om redenen van
                ...
                <li>
                    Alcoholische dranken waarvan de prijs is overeengekomen bij
                ...
                <li>
                    Verzegelde audio-, video-opnamen en computerprogrammatuur,
                ...
                <li>
                    De levering van digitale inhoud anders dan op een materiële
            ...
            <ol>
                <li>
                    ...
                    de prijzen van de aangeboden producten en/of diensten niet
                ...
                <li>
                    ...
                    of diensten waarvan de prijzen gebonden zijn aan
                    schommelingen op de financiële markt en waar de ondernemer
                    geen invloed op heeft, met variabele prijzen aanbieden. Deze
                    gebondenheid aan schommelingen en het feit dat eventueel
                    vermelde prijzen richtprijzen zijn, worden bij het aanbod
                    vermeld.
                </li>
                <li>
            ...
            <ol>
                ...
                <li>
                    Een door de ondernemer, diens toeleverancier, fabrikant of
                    ...
                    indien de ondernemer is tekortgeschoten in de nakoming van
                    zijn deel van de overeenkomst.
                </li>
                <li>
                    Onder extra garantie wordt verstaan iedere verbintenis van
                    de ondernemer, diens toeleverancier, importeur of producent
                    waarin deze aan de consument bepaalde rechten of vorderingen
                    toekent die verder gaan dan waartoe deze wettelijk verplicht
                    is in geval hij is tekortgeschoten in de nakoming van zijn
            ...
            <ol>
                ...
                <li>
                    ...
                    leveringstermijn is overeengekomen. Indien de bezorging
                    ...
                    geplaatst heeft bericht. De consument heeft in dat geval het
                    recht om de overeenkomst zonder kosten te ontbinden en recht
                    op eventuele schadevergoeding.
                </li>
                <li>
                    Na ontbinding conform het vorige lid zal de ondernemer het
                ...
                <li>
                    ...
                    bekend gemaakte vertegenwoordiger, tenzij uitdrukkelijk
            ...
            <ol>
                <li>
                    ...
                    allen tijde opzeggen met inachtneming van daartoe
                    overeengekomen opzeggingsregels en een opzegtermijn van ten
                    hoogste één maand.
                </li>
                <li>
                    De consument kan een overeenkomst die voor bepaalde tijd is
                    aangegaan en die strekt tot het geregeld afleveren van
                    producten (elektriciteit daaronder begrepen) of diensten, te
            ...
            <ol start='4'>
                <li>
                    ...
                    stilzwijgend worden verlengd of vernieuwd voor een bepaalde
                    duur.
                </li>
                <li>
                    ...
                    tijdschriften stilzwijgend worden verlengd voor een bepaalde
                ...
                <li>
                    ...
                    mag alleen stilzwijgend voor onbepaalde duur worden verlengd
                    als de consument te allen tijde mag opzeggen met een
                    opzegtermijn van ten hoogste één maand. De opzegtermijn is
                    ten hoogste drie maanden in geval de overeenkomst strekt tot
                    het geregeld, maar minder dan eenmaal per maand, afleveren
            ...
            <ol start='8'>
                <li>
                    ...
                    tenzij de redelijkheid en billijkheid zich tegen opzegging
            ...
            <ol>
                <li>
                    Voor zover niet anders is bepaald in de overeenkomst of
                    aanvullende voorwaarden, dienen de door de consument
                    verschuldigde bedragen te worden voldaan binnen 14 dagen na
                    het ingaan van de bedenktermijn, of bij het ontbreken van
                    een bedenktermijn binnen 14 dagen na het sluiten van de
                    overeenkomst. In geval van een overeenkomst tot het verlenen
                    van een dienst, vangt deze termijn aan op de dag nadat de
                    consument de bevestiging van de overeenkomst heeft
                    ontvangen.
                </li>
                <li>
                    Bij de verkoop van producten aan consumenten mag de
                ...
                <li>
                    ...
                    of vermelde betaalgegevens onverwijld aan de ondernemer te
                    melden.
                </li>
                <li>
                    Indien de consument niet tijdig aan zijn
                    betalingsverplichting(en) voldoet, is deze, nadat hij door
                    de ondernemer is gewezen op de te late betaling en de
                    ondernemer de consument een termijn van 14 dagen heeft
                    gegund om alsnog aan zijn betalingsverplichtingen te
                    voldoen, na het uitblijven van betaling binnen deze
                    14-dagen-termijn, over het nog verschuldigde bedrag de
                    wettelijke rente verschuldigd en is de ondernemer gerechtigd
                    de door hem gemaakte buitengerechtelijke incassokosten in
                    rekening te brengen. Deze incassokosten bedragen maximaal:
                    15% over openstaande bedragen tot € 2.500,=; 10% over de
                    daaropvolgende € 2.500,= en 5% over de volgende € 5.000,=
                    met een minimum van € 40,=. De ondernemer kan ten voordele
                    van de consument afwijken van genoemde bedragen en
                    percentages.
                </li>
            </ol>
            <p>
            ...
            <ol>
                ...
                <li>
                    De consument dient de ondernemer in ieder geval 4 weken de
                    tijd te geven om de klacht in onderling overleg op te
                    lossen. Na deze termijn ontstaat een geschil dat vatbaar is
            ...
            <ol>
                ...
                <li>
                    ...
                    producten en diensten, kunnen, met inachtneming van het
                    hierna bepaalde, zowel door de consument als de ondernemer
                    worden voorgelegd aan de Geschillencommissie Thuiswinkel,
                    Postbus 90600, 2509 LP te Den Haag (
                    <a href='http://www.sgc.nl/'>www.sgc.nl</a>
                    ).
                </li>
                <li>
                ...
                <li>
                    Leidt de klacht niet tot een oplossing dan moet het geschil
                    uiterlijk&nbsp;12 maanden na de datum waarop de consument de
                    klacht bij de ondernemer indiende, schriftelijk of in een
                    andere door de Commissie te bepalen vorm bij de
                    Geschillencommissie aanhangig worden gemaakt.
                </li>
                <li>
                    Wanneer de consument een geschil wil voorleggen aan de
                    Geschillencommissie, is de ondernemer aan deze keuze
                    gebonden. Bij voorkeur meldt de consument dit eerst aan de
                    ondernemer.
                </li>
                <li>
                    Wanneer de ondernemer een geschil wil voorleggen aan de
                    Geschillencommissie, zal de consument binnen vijf weken na
                    een daartoe door de ondernemer schriftelijk gedaan verzoek,
                    schriftelijk dienen uit te spreken of hij zulks ook wenst
                    dan wel het geschil wil laten behandelen door de daartoe
                    bevoegde rechter. Verneemt de ondernemer de keuze van de
                    consument niet binnen de termijn van vijf weken, dan is de
                    ondernemer gerechtigd het geschil voor te leggen aan de
                    bevoegde rechter.&nbsp;
                </li>
                <li>
                    De Geschillencommissie doet uitspraak onder de voorwaarden
                    zoals deze zijn vastgesteld in het reglement van de
                    Geschillencommissie (
                    <a href='http://www.degeschillencommissie.nl/over-ons/de-commissies/2404/thuiswinkel'>
                ...
                <li>
                    ...
                    betaling is verleend, deze in staat van faillissement is
                    geraakt of zijn bedrijfsactiviteiten feitelijk heeft
                    beëindigd, voordat een geschil door de commissie op de
                    zitting is behandeld en een einduitspraak is gewezen.
                </li>
                <li>
                    Indien naast de Geschillencommissie Thuiswinkel een andere
                    erkende of bij de Stichting Geschillencommissies voor
                    Consumentenzaken (SGC) of het Klachteninstituut Financiële
                    Dienstverlening (Kifid) aangesloten geschillencommissie
                    bevoegd is, is voor geschillen betreffende hoofdzakelijk de
                    methode van verkoop of dienstverlening op afstand de
                    Geschillencommissie Thuiswinkel bij voorkeur bevoegd. Voor
                    alle overige geschillen de andere erkende bij SGC of Kifid
            ...
            <ol>
                <li>
                    Thuiswinkel.org staat garant voor de nakoming van de
                    bindende adviezen van de Geschillencommissie Thuiswinkel
                    door haar leden, tenzij het lid besluit het bindend advies
                    binnen twee maanden na de verzending ervan ter toetsing aan
                    de rechter voor te leggen. Deze garantstelling herleeft,
                    indien het bindend advies na toetsing door de rechter in
                    stand is gebleven en het vonnis waaruit dit blijkt, in
                    kracht van gewijsde is gegaan. Tot maximaal een bedrag van
                    €10.000,- per bindend advies, wordt dit bedrag door
                    Thuiswinkel.org aan de consument uitgekeerd. Bij bedragen
                    groter dan €10.000,- per bindend advies, wordt €10.000,-
                ...
                <li>
                    Voor toepassing van deze garantie is vereist dat de
                    consument een schriftelijk beroep hierop doet bij
                    Thuiswinkel.org en dat hij zijn vordering op de ondernemer
                    overdraagt aan Thuiswinkel.org. Indien de vordering op de
                    ondernemer meer bedraagt dan €10.000,-, wordt de consument
                    aangeboden zijn vordering voor zover die boven het bedrag
                    van €10.000,- uitkomt over te dragen aan Thuiswinkel.org,
                    waarna deze organisatie op eigen naam en kosten de betaling
                    daarvan in rechte zal vragen ter voldoening aan de
                    consument.
                </li>
            </ol>
            <p>
            ...
            opgeslagen op een duurzame gegevensdrager. <br />
            <p>
                <strong>
            ...
            <ol>
                <li>
                    Thuiswinkel.org zal deze algemene voorwaarden niet wijzigen
                    dan in overleg met de Consumentenbond.
                </li>
                <li>
                    Wijzigingen in deze voorwaarden zijn slechts van kracht
                    nadat deze op daartoe geëigende wijze zijn gepubliceerd, met
                    dien verstande, dat bij toepasselijke wijzigingen gedurende
                    de looptijd van een aanbod de voor de consument meest
            ...
            <ul>
                ...
                <li>
                    [Handtekening consument(en)] (alleen wanneer dit formulier
                    op papier wordt ingediend)
                </li>
            </ul>
            <p>
                * Doorhalen wat niet van toepassing is of invullen wat van
                toepassing is.<strong></strong>
            </p>
        </div>
    )
}
