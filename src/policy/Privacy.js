...
const Privacy = () => {
    return (
        <div class='container mb-5 mt-5 text-white'>
            <div class='row'>
                <div class='col-md-12'>
                    <h1>Cookie Policy for multiversum</h1>
                    <p>
                        This is the Cookie Policy for multiversum, accessible
                        from https://react.multiversumvr.nl/
                    </p>
                    <p>
                        <strong>
                            What
                                        ...
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                ...
                                                <p>
                                                    ...
                                                    that they shared and/or
                                                    collect in Multiversum. This
                                                    policy is not applicable to
                                                    any information collected
                                                    offline or via channels
                                                    other than this website. Our
                                                    Privacy Policy was created
                                                ...
                                                <p>
                                                    ...
                                                    hereby consent to our
                                                    Privacy Policy and agree to
                                                    its terms.
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    provide, and the reasons why
                                                    you are asked to provide it,
                                                    will be made clear to you at
                                                    the point we ask you to
                                                ...
                                                <h2>Log Files</h2>
                                                <p>
                                                    Multiversum follows a
                                                    standard procedure of using
                                                    log files. These files log
                                                    visitors when they visit
                                                    websites. All hosting
                                                    companies do this and a part
                                                    of hosting services'
                                                    analytics. The information
                                                    collected by log files
                                                    include internet protocol
                                                    (IP) addresses, browser
                                                    type, Internet Service
                                                    Provider (ISP), date and
                                                    time stamp, referring/exit
                                                    pages, and possibly the
                                                    number of clicks. These are
                                                    not linked to any
                                                    information that is
                                                    ...
                                                    tracking users' movement on
                                                    the website, and gathering
                                                    demographic information.
                                                </p>
                                                <h2>Cookies and Web Beacons</h2>
                                                <p>
                                                    Like any other website,
                                                    Multiversum uses 'cookies'.
                                                    These cookies are used to
                                                    store information including
                                                    visitors' preferences, and
                                                    the pages on the website
                                                    that the visitor accessed or
                                                    visited. The information is
                                                    used to optimize the users'
                                                    experience by customizing
                                                    our web page content based
                                                    on visitors' browser type
                                                    and/or other information.
                                                </p>
                                                <p>
                                                    For more general information
                                                    on cookies, please read{' '}
                                                    <a href='https://www.privacypolicyonline.com/what-are-cookies/'>
                                                        "What Are Cookies"
                                                    </a>
                                                    . Information regarding
                                                    cookies from this Cookies
                                                    Policy are from{' '}
                                                ...
                                                <p>
                                                    You may consult this list to
                                                    find the Privacy Policy for
                                                    each of the advertising
                                                    partners of Multiversum.
                                                </p>
                                                <p>
                                                    Third-party ad servers or ad
                                                    networks uses technologies
                                                    like cookies, JavaScript, or
                                                    Web Beacons that are used in
                                                    their respective
                                                    advertisements and links
                                                    that appear on Multiversum,
                                                    which are sent directly to
                                                    users' browser. They
                                                    ...
                                                    content that you see on
                                                    websites that you visit.
                                                </p>
                                                <p>
                                                    Note that Multiversum has no
                                                    access to or control over
                                                    these cookies that are used
                                                ...
                                                <p>
                                                    ...
                                                    cookies through your
                                                    individual browser options.
                                                    To know more detailed
                                                    information about cookie
                                                    management with specific web
                                                    browsers, it can be found at
                                                    the browsers' respective
                                                    websites.
                                                </p>
                                                <h2>
                                                    CCPA Privacy Rights (Do Not
                                                    Sell My Personal
                                                    Information)
                                                </h2>
                                                <p>
                                                ...
                                                <p>
                                                    ...
                                                    about the consumer that a
                                                    business has collected.
                                                </p>
                                                <p>
                                                    Request that a business that
                                                    sells a consumer's personal
                                                    data, not sell the
                                                    consumer's personal data.
                                                </p>
                                                <p>
                                                    If you make a request, we
                                                    have one month to respond to
                                                ...
                                                <p>
                                                    ...
                                                    you are fully aware of all
                                                    of your data protection
                                                    rights. Every user is
                                                    entitled to the following:
                                                </p>
                                                <p>
                                                    The right to access – You
                                                ...
                                                <p>
                                                    Another part of our priority
                                                    is adding protection for
                                                    children while using the
                                                    internet. We encourage
                                                    parents and guardians to
                                                    observe, participate in,
                                                    and/or monitor and guide
                                                    their online activity.
                                                </p>
                                                <p>
                                                    Multiversum does not
                                                    knowingly collect any
                                                    Personal Identifiable
                                                    Information from children
                                                    under the age of 13. If you
                                                    think that your child
                                                    provided this kind of
                                                    information on our website,
                                                    we strongly encourage you to
                                                    contact us immediately and
                                                    we will do our best efforts
                                                    to promptly remove such
                    ...
                    <p>
                        ...
                        . Information regarding cookies from this Cookies Policy
                        are from
                        <a href='https://www.generateprivacypolicy.com/'>
                    ...
                    <p>
                        ...
                        disable cookies. This Cookies Policy was created with
                        the help of the{' '}
                        <a href='https://www.cookiepolicygenerator.com/cookie-policy-generator/'>
                            Cookies Policy Generator from
                            CookiePolicyGenerator.com
                        </a>
                        .
                    </p>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>
                                If you create an account with us then we will
                                use cookies for the management of the signup
                                process and general administration. These
                                cookies will usually be deleted when you log out
                                however in some cases they may remain afterwards
                                to remember your site preferences when logged
                                out.
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                We use cookies when you are logged in so that we
                                can remember this fact. This prevents you from
                                having to log in every single time you visit a
                                new page. These cookies are typically removed or
                                cleared when you log out to ensure that you can
                                only access restricted features and areas when
                                logged in.
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <p>
                                We also use social media buttons and/or plugins
                                on this site that allow you to connect with your
                                social network in various ways. For these to
                                work the following social media sites including;
                                List the social networks whose features you have
                                integrated with your site, will set cookies
                                through our site which may be used to enhance
                                your profile on their site or contribute to the
                                data they hold for various purposes outlined in
                    ...
                    <ul>
                        <li>Email: info@multiversum.nl</li>
                    </ul>
                </div>
            </div>
        </div>
